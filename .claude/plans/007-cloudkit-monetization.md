...
- [x] **Step 1: Conditional CloudKit container setup**
...
- [x] **Step 1: Link StoreKit.framework in project generator**
...
- [x] **Step 3: Write SubscriptionManager.swift**
...
- [x] **Step 1: Add SubscriptionManager to AppEnvironment**
...
- [x] **Step 1: Add tier gating to TransitionManager**
...
- [x] **Step 2: Wire tier state from RadioView**
...
- [x] **Step 3: Add tier badge to RadioView**
...
- [x] **Step 3: Verify StoreKit fallback**
