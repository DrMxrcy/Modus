...
- [x] **Step 1: Add framework UUIDs near the top of the generator**
...
- [x] **Step 2: Add PBXBuildFile entries for frameworks**
...
- [x] **Step 3: Add PBXFileReference entries for frameworks**
...
- [x] **Step 4: Add framework build files to the Frameworks phase**
...
- [x] **Step 5: Regenerate the Xcode project**
...
- [x] **Step 6: Verify the framework linkage builds**
...
- [x] **Step 1: Add `isAvailable` to the protocol**
...
- [x] **Step 2: Add `isAvailable` to MockMusicProvider**
...
- [x] **Step 3: Build to verify protocol consistency**
...
- [x] **Step 1: Write AppleMusicProvider.swift**
...
- [x] **Step 2: Build to verify MusicKit API compatibility**
...
- [x] **Step 1: Add async availability resolution to AppEnvironment**
...
- [x] **Step 2: Build to verify availability logic compiles**
...
- [x] **Step 1: Replace RadioView with real playback observation**
...
- [x] **Step 2: Build to verify RadioView changes**
...
- [x] **Step 4: Test lock-screen controls**
...
- [x] **Step 5: Test background audio**
