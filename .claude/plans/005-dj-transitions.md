...
- [x] **Step 1: Write TTSClient.swift**
...
- [x] **Step 1: Link AVFoundation.framework in project generator**
...
- [x] **Step 3: Write AudioDucker.swift**
...
- [x] **Step 1: Write TransitionManager.swift**
...
- [x] **Step 1: Add TransitionManager to AppEnvironment**
...
- [x] **Step 1: Pre-render transition on track load, execute on skip**
