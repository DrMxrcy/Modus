...
private let logger = Logger(subsystem: "app.echodj", category: "SubscriptionManager")
...
enum StoreKitProductID {
    ...
    /// `EchoDJ.storekit` and the real App Store Connect group (when configured).
    ...
    static let proMonthly = "com.echodj.app.pro.monthly"
}
