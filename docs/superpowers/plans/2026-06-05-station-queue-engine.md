...
- [ ] **Step 1: Add MusicKit convenience initializer**
...
- [ ] **Step 2: Build to verify conditional compilation**
...
- [ ] **Step 1: Write StationQueueManager.swift**
...
- [ ] **Step 2: Build to verify StationQueueManager compiles**
...
- [ ] **Step 1: Add StationQueueManager to AppEnvironment**
...
- [ ] **Step 1: Replace single-play tap with station seeding**
...
- [ ] **Step 1: Add upcoming tracks state and fetch logic**
